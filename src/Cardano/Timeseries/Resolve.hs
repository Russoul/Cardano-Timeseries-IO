...
resolveExpr' defs Expr.True = Expr.True
resolveExpr' defs Expr.False = Expr.False
...
resolveExpr' defs (Milliseconds l) = Milliseconds l
resolveExpr' defs (Seconds l) = Seconds l
resolveExpr' defs (Minutes l) = Minutes l
resolveExpr' defs (Hours l) = Hours l
...
resolveExpr' defs Epoch = Epoch
resolveExpr' defs Now = Now
